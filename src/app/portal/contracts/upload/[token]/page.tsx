...
export default function DropzonePage() {
  ...
  return (
    // 1. Scroll habilitado y fondo adaptado al tema global
    <div className="h-dvh w-full overflow-y-auto overflow-x-hidden bg-surface-0 text-text-primary selection:bg-accent-bioalert/30 font-sans isolate">
      ...
      <main className="container max-w-3xl mx-auto px-6 py-12 md:py-24 relative z-10">
